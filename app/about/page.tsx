...
export default function About() {
  return (
    <div className="text-center max-w-2xl bg-white text-black p-6 rounded-lg">
      <h2 className="text-3xl md:text-4xl font-bold mb-4">About Botshyka</h2>
      <p className="text-lg mb-4">
        Botshyka is a platform dedicated to showcasing the best chatbots for various use cases. We aim to connect creators and users through innovative chatbot solutions.
      </p>
      <p className="text-lg mb-4">
